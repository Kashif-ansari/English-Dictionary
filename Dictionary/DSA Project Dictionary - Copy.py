...
def addclear():
    addenterwordEntry.delete(0,END)
...
addenterwordlabel = Label(root,text='Add Word',font=('castellar',25,'bold',),foreground='red')
addenterwordlabel.place(x=80,y=20)

addenterwordEntry = Entry(root,font=('arial',23,'bold'),justify=CENTER,bd=8,relief=GROOVE)
addenterwordEntry.place(x=30,y=80)
...
addMeaninglabel = Label(root,text='Add Meaning',font=('castellar',30,'bold',),foreground='red')
addMeaninglabel.place(x=60,y=200)

addtextarea = Text(root,width=32,height=8,font=('arial',18,'bold'),bd=8,relief=GROOVE)
addtextarea.place(x=10,y=270)
...
addclearimage = PhotoImage(file='clear.png')
addclearButton = Button(root,image = clearimage, bd = 0,bg='whitesmoke',cursor='hand2',activebackground='whitesmoke', command=addclear)
addclearButton.place(x=100,y=530)

addButtonimage = PhotoImage(file='addition.png')
addButton = Button(root,image = addButtonimage, bd = 0,cursor='hand2',activebackground='whitesmoke', command=addclear)
addButton.place(x=200,y=530)
